...
func (s *DictionaryDetailApi) DeleteSysDictionaryDetail(c *gin.Context) {
	...
	err = dictionaryDetailService.DeleteSysDictionaryDetails(ids)
	if err != nil {
...
func (b *DictionaryDetailApi) ChangeSort(c *gin.Context) {
	var dictionary system.SysDictionaryDetail

	err := c.ShouldBindJSON(&dictionary)

	err = dictionaryDetailService.ChangeStatus(system.SysDictionaryDetail{
...
func (b *DictionaryDetailApi) ChangeStatus(c *gin.Context) {
...
func (s *DictionaryDetailApi) FindSysDictionaryDetail(c *gin.Context) {
	...
	response.OkWithDetailed(gin.H{"list": reSysDictionaryDetail}, "查询成功", c)
}
