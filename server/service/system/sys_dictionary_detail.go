...
func (dictionaryDetailService *DictionaryDetailService) DeleteSysDictionaryDetails(ids request2.IdsReq) (err error) {
	var sysDictionaryDetail system.SysDictionaryDetail
	err = global.GVA_DB.Where("id in (?)", ids.Ids).Delete(&sysDictionaryDetail).Error
...
func (dictionaryDetailService *DictionaryDetailService) ChangeStatus(req system.SysDictionaryDetail) (err error) {
	return global.GVA_DB.Model(&system.SysDictionaryDetail{}).
