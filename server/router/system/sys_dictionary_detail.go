...
func (s *DictionaryDetailRouter) InitSysDictionaryDetailRouter(Router *gin.RouterGroup) {
	...
	sysDictionaryDetailApi := v1.ApiGroupApp.SystemApiGroup.DictionaryDetailApi
	{
		...
		dictionaryDetailRouter.PUT("changeStatus", sysDictionaryDetailApi.ChangeStatus)                              // 更新SysDictionaryDetail
		dictionaryDetailRouter.PUT("changeSort", sysDictionaryDetailApi.ChangeSort)                                  // 更新SysDictionaryDetail
